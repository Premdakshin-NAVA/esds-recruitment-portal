...
const cases = [
  {
    ...
    expect: { amount: 450, direction: "debit", merchant: "swiggy", channel: "upi", ref_no: "519201234567", account_hint: "HDFC Bank ··1234", payment_mode: "UPI" },
  },
  {
    name: "ICICI card spend",
    text: "INR 2,349.00 spent on ICICI Bank Card XX7003 on 12-Jul-26 at AMAZON. Avl Lmt: INR 1,05,000.",
    expect: { amount: 2349, direction: "debit", merchant: "AMAZON", channel: "card", account_hint: "··7003", payment_mode: null },
  },
  {
    name: "SBI UPI credit",
    text: "Your a/c no. XX5678 is credited by Rs.55,000.00 on 01-07-26 from VPA employer@ybl (UPI Ref no 123456789012) - SBI Bank",
    expect: { amount: 55000, direction: "credit", merchant: "employer", channel: "upi", ref_no: "123456789012", payment_mode: "PhonePe" },
  },
  {
    ...
    expect: { amount: 199, direction: "debit", merchant: "Netflix India", channel: "upi", ref_no: "987654321012", payment_mode: "UPI" },
  },
  {
    ...
    expect: { amount: 1200, direction: "debit", merchant: "bigbasket", channel: "upi", payment_mode: "UPI" },
  },
  {
    name: "Paytm wallet-linked UPI",
    text: "Rs.150.00 debited from A/c XX1234 on 12-Jul-26 to VPA merchant@paytm (UPI Ref No 519201234568) -HDFC Bank",
    expect: { payment_mode: "Paytm" },
  },
  {
    name: "NEFT online transfer",
    text: "Rs.5000.00 debited from A/c XX1234 towards NEFT transfer on 12-Jul-26. Ref No 519201234569 -HDFC Bank",
    expect: { payment_mode: "Online Transaction" },
  },
  {
    name: "Debit card spend",
    text: "Rs.850.00 spent using your HDFC Bank Debit Card XX1234 at BIGBASKET on 12-Jul-26. Ref No 519201234570.",
    expect: { payment_mode: "Debit Card" },
  },
  {
  ...
  },
  {
    ...
    expect: { amount: 96, direction: "debit", merchant: "paytm.s24i7q8", channel: "upi", ref_no: "126569762285", account_hint: "··8754", payment_mode: "RuPay Card" },
  },
  {
    ...
    expect: { amount: 10000, direction: "debit", merchant: "PREMA S", channel: "upi", ref_no: "126559079050", account_hint: "··7492", payment_mode: "Google Pay" },
  },
  {
    ...
    expect: { amount: 1400, direction: "debit", merchant: "URBANCLAP TECHNOLOGIES", channel: "card", account_hint: "··9746", payment_mode: "Credit Card" },
  },
  {
    ...
    expect: { amount: 103.2, direction: "credit", merchant: "ORACLE SINGAPORE", channel: "card", account_hint: "··9746", payment_mode: "Credit Card" },
  },
];
